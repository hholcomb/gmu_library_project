== README
24 Apr HH
  1. created tag named v1.0 to represent the structrure as it was on 22 Apr and pushed to github
  ...
  4. set up the database with data for User
   ...
   6. create the Sessions controller using the command
    ...
    8. can test out the login function from localhost:3000/login
